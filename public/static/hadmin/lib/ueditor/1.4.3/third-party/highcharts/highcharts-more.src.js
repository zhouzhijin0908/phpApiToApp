...
wrap(seriesTypes.spline.prototype, 'getPointSpline', function (proceed, segment, point, i) {
	...
	var ret,
		smoothing = 1.5, // 1 means controller points midway between points, 2 means 1/3 from the point, 3 is 1/4 etc;
		denom = smoothing + 1,
		plotX, 
		plotY,
		lastPoint,
	...
	if (this.chart.polar) {
		...
		if (lastPoint && nextPoint) {
			...
			// Find the corrected controller points for a spline straight through the point
